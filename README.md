...
# 📖 [Random Greeting App] <a name="about-project"></a>

**[Random Greeting App]** is a fullstack web application that randomly displays greetings whenever the user refreshes the page.
...
```sh
  ...
  git clone https://github.com/Fombi-Favour/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Fombi-Favour/hello-rails-react/issues).
...
I would like to thank  everybody most especially the Microverse staffs for making it possible to work on the first final capstone project.
